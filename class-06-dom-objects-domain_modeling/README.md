...
- Announcements
  - All reading, quiz, journal, and career assignments can be submitted (or re-submitted) for full credit...even if they're late.
  - As long as you had a reasonable attempt at a lab assignment turned in on time, you can resubmit your lab for full credit. In fact, we want you to do this - it's how you keep improving your code.

- Go over student surveys *[15 minutes]*
- [Code Review](#codereview) *[30 minutes]*
- [Domain modeling and objects](#readings) *[45 minutes]*
- Break *[15 minutes]*
- [The DOM](#readings) *[60 minutes]*
- Go over the lab for this week *[15 minutes]*
...
- Let's take a look at another about_me project or two.
